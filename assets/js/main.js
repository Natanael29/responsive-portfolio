...
function initAccordionSkills() {
    ...
    function toggleSkills() {
        let itemClass = $(this).parent().attr('class');

        skillsContent.each(function() {
            $(this).removeClass();
            $(this).addClass("skills__content skills__close");
        });

        if (itemClass === 'skills__content skills__close') {
            $(this).parent().addClass('skills__content skills__open');
        }
